...
// pop() - мутирующий, удаляет элемент из конца, возвращает удаленный элемент
// unshift() - мутирующий, добавляет элемент в начало массива, возвращает длину нового массива
// shift() - мутирующий, удаляет элемент из начала, возвращает удаленный элемент

// map() - не мутирующий, возвращает новый массив, проводит операции с каждым элементом массива и создает новый
// forEach() - мутирующий, возвращает undefined, проводит операции с каждым элементом исходного массива
// filter() - не мутирующий, возвращает новый массив с элементами, которые удовлетворяют заданному условию (всегда возвращает массив)

// reduce() - не мутирующий, возвращает переменную с последовательной обработкой элементов в массиве,
// принимает 2 аргумента:
// 1. стрелочную функцию с возвращаемой переменной и переменной с промежуточным значением
