...
class Congak extends Alcohol {
    constructor(title, strength, volume, age, coutry){
...
const byanka = new Martini("Мартини", 30, 0.7, 30)
const armyansky = new Congak("Армянский", 40, 0.5, 20, "Armeny")
byanka.drink()
armyansky.drink()

byanka.reduce()
byanka.reduce()
console.log(byanka.volume)
